...
describe('Create red-flag record API', () => {
  beforeEach((done) => {
  ...
  it('should create a new red-flag record with complete input', (done) => {
    chai.request(app)
      .post(route)
      ...
      .end((err, res) => {
        ...
        expect(res.body.data[0]).to.have.property('message').to.equal('Created red-flag record');
